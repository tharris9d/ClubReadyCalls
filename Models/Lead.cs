...
namespace ClubReady.Modules.ClubReadyCalls.Models
{
    [TableName("ClubReadyCalls_Leads")]
    //setup the primary key for table
    [PrimaryKey("LeadId", AutoIncrement = true)]
    //configure caching using PetaPoco
    [Cacheable("Leads", CacheItemPriority.Default, 20)]
    ...
    public class Lead
    {
        ...
        ///<summary>
        /// The ClubReadyUserId of the Lead
        ///</summary>
        public int ClubReadyUserId { get; set; }
